/*
 * baseboard_cpld.c - The CPLD driver for the Base Board of Phalanx2
 * The driver implement sysfs to access CPLD register on the baseboard of Phalanx2 via LPC bus.
...
MODULE_DESCRIPTION("Celestica Phalanx2 CPLD baseboard driver");
